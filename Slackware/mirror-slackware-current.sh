...
# Modified: MDrights <mdrights@tutanota.de>
#
# ===========================================================================
...
# Your name/email:
BUILDER=${BUILDER:-"MDrights <mdrights@tutanota.de>"}
...
SLACKROOTDIR=${SLACKROOTDIR:-"/home/user/slackware-repo"}
...
EXCLUDES=${EXCLUDES:-"--exclude kde --exclude kdei"}
